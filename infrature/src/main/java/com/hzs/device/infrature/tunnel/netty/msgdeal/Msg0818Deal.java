...
@Slf4j
@Component
public class Msg0818Deal extends ConnectMsgDeal{
    ...
    public boolean execute(List<Integer> msg, ChannelHandlerContext context) {
        ...
        log.info("Msg0818Deal execute, msg:{}", msg);
        ConnectMsg connectMsg = convert(msg, context);


        sendToDevice(commonResponse.getMsgData(connectMsg.getDeviceId(), msg.get(11), msg.get(12), 0x08, 0x18, 0)
