...
@Slf4j
@Component
public class Msg0115Deal extends ConnectMsgDeal{
    ...
    public boolean execute(List<Integer> msg, ChannelHandlerContext context) {
        ...
        log.info("Msg0115Deal execute, msg:{}", msg);
        ConnectMsg connectMsg = convert(msg, context);


        sendToDevice(commonResponse.getMsgData(connectMsg.getDeviceId(), msg.get(11), msg.get(12), 0x01, 0x15, 0)
