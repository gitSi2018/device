...
@Slf4j
@Component
public class SleepMsgResponse extends MsgOutServiceAbstract{


    @Override
    public String point() {

        return MsgSendIDEnum.SLEEP_RESPONSE.getMsgKey();
    }

    @Override
    public List<Integer> getMsgId() {

        return MsgSendIDEnum.SLEEP_RESPONSE.getMsgId();
    }
    ...
    public List<Integer> getMsgData(String deviceId, Integer... sendData) {
        ...
        //id
        msgSend.addAll(MsgSendIDEnum.SLEEP_RESPONSE.getMsgId());
        //消息属性
        msgSend.addAll(Arrays.asList(0x00, 0x00));
        //手机号
        msgSend.addAll(phoneToArrays(deviceId));
        //消息流水号
        msgSend.addAll(getMsgNum(MsgSendIDEnum.SLEEP_RESPONSE));
