...
@Slf4j
@Component
public class Msg1006Deal extends ConnectMsgDeal{
    ...
    public boolean execute(List<Integer> msg, ChannelHandlerContext context) {
        ...
        log.info("Msg1006Deal execute, msg:{}", msg);
        ConnectMsg connectMsg = convert(msg, context);


        sendToDevice(commonResponse.getMsgData(connectMsg.getDeviceId(), msg.get(11), msg.get(12), 0x10, 0x06, 0)
