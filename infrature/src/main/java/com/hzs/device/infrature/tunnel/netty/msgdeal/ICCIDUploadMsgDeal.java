...
@Slf4j
@Component
public class ICCIDUploadMsgDeal extends  ConnectMsgDeal{
    ...
    public boolean execute(List<Integer> msg, ChannelHandlerContext context) {
        ...
        log.info("ICCIDUploadMsgDeal execute, msg:{}, context:{}", msg, context);

        ConnectMsg connectMsg = convert(msg, context);
        sendToDevice(commonResponse.getMsgData(connectMsg.getDeviceId(), msg.get(11), msg.get(12), 0x01, 0x07, 0)
