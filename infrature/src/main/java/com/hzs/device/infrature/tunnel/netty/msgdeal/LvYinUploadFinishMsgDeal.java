...
@Slf4j
@Component
public class LvYinUploadFinishMsgDeal extends ConnectMsgDeal{
    ...
    public boolean execute(List<Integer> msg, ChannelHandlerContext context) {
        ...
        log.info("LvYinUpload2MsgDeal execute, msg:{}", msg);
        ConnectMsg connectMsg = convert(msg, context);


        sendToDevice(commonResponse.getMsgData(connectMsg.getDeviceId(), msg.get(11), msg.get(12), 0x01, 0x19, 0)
